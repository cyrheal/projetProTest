...
<script defer src="../assets/js/tableResponsive.js"></script><!--  defer rapidité execution = fonction asynchrone-->
<script src="../assets/MDB-Free_4.7.0/js/jquery-3.3.1.min.js" type="text/javascript"></script>
